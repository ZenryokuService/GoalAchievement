...
Within that, we will create a flow for achieving our goals.<br>
  ...
  <dd>
    <ul>
      <li>
        <dl>
          <dt>Lv1: 1.Implementation item(ID:1)</dt>
      ...
      <li>
        <dl>
          <dt>Lv1: 2. Implementation item２(ID:2)</dt>
      ...
      <li>
        <dl>
          <dt>Lv1: 3. Implementation item３(ID:3)</dt>
...
<dl><dt>Lv0: Create <a href=“https://github.com/ZenryokuService/JankenGame”>JankenGame</a> and release it.</dt>
  <dd>
    <ul>
      <li>
        <dl>
          <dt>Lv1: Create a rockfish game Ver 1.0</dt>
      ...
      <li>
        <dl>
          <dt>Lv1: Get a free GLUON license</dt>
      ...
      <li>
        <dl>
          <dt>Lv1: Apply for Goole app store App</dt>
