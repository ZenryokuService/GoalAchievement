...
const ENGLISH_CATEGORIES = [
    {id: 0, categName: "Infomation Technology", url: ""},
    {id: 1, categName: "Network", url: ""},
    {id: 2, categName: "Sensor", url: ""},
    {id: 3, categName: "Iternet Of Things", url: ""},
    {id: 4, categName: "Transport", url: ""},
    {id: 5, categName: "Energy", url: ""},
    {id: 6, categName: "Agriculture", url: ""},
    {id: 7, categName: "Architecture", url: ""},
    {id: 8, categName: "Entertaiment & Media", url: ""},
    {id: 9, categName: "Art & Music", url: ""},
    {id: 10, categName: "Appliance", url: ""},
    {id: 11, categName: "Industrial Machine", url: ""},
    {id: 12, categName: "Clothing & Accesorries", url: ""},
    {id: 13, categName: "Medical Technology", url: ""},
    {id: 14, categName: "Assistive Technology", url: ""},
    {id: 15, categName: "Science", url: ""},
    {id: 16, categName: "Space", url: ""},
    {id: 17, categName: "Robotics", url: ""},
    {id: 18, categName: "ArtificalIntelligence", url: ""},
    {id: 19, categName: "Superintelligence", url: ""}
];

const JAPANESE_CATEGORIES = [
    {id: 0, categName: "情報技術", url: ""},
    {id: 1, categName: "通信網", url: ""},
    {id: 2, categName: "センサー", url: ""},
    {id: 3, categName: "IoT", url: ""},
    {id: 4, categName: "輸送", url: ""},
    {id: 5, categName: "エネルギー", url: ""},
    {id: 6, categName: "農業", url: ""},
    {id: 7, categName: "建築", url: ""},
    {id: 8, categName: "エンターテイメント＆メディア", url: ""},
    {id: 9, categName: "アート＆ミュージック", url: ""},
    {id: 10, categName: "専用機器", url: ""},
    {id: 11, categName: "産業機械", url: ""},
    {id: 12, categName: "服とアクセサリー", url: ""},
    {id: 13, categName: "医療技術", url: ""},
    {id: 14, categName: "支援技術", url: ""},
    {id: 15, categName: "科学", url: ""},
    {id: 16, categName: "宇宙", url: ""},
    {id: 17, categName: "ロボット", url: ""},
    {id: 18, categName: "人工知能", url: ""},
    {id: 19, categName: "スーパーインテリジェンス", url: ""}
];
